...
namespace Yggdrasil.Domain.Rigging
{
    ...
    public class SourceBoneMapping
    {
        ...
        // Fingies
        public RigSlot LeftHandThumb1Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger0",       "Thumb 1");
        public RigSlot LeftHandThumb2Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger01",      "Thumb 2");
        public RigSlot LeftHandThumb3Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger02",      "Thumb 3");
        public RigSlot LeftHandIndex1Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger1",       "Index 1");
        public RigSlot LeftHandIndex2Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger11",      "Index 2");
        public RigSlot LeftHandIndex3Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger12",      "Index 3");
        public RigSlot LeftHandMiddle1Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_L_Finger2",       "Middle 1");
        public RigSlot LeftHandMiddle2Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_L_Finger21",      "Middle 2");
        public RigSlot LeftHandMiddle3Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_L_Finger22",      "Middle 3");
        public RigSlot LeftHandRing1Slot { get; set; } = new RigSlot(       "ValveBiped.Bip01_L_Finger3",       "Ring 1");
        public RigSlot LeftHandRing2Slot { get; set; } = new RigSlot(       "ValveBiped.Bip01_L_Finger31",      "Ring 2");
        public RigSlot LeftHandRing3Slot { get; set; } = new RigSlot(       "ValveBiped.Bip01_L_Finger32",      "Ring 3");
        public RigSlot LeftHandPinky1Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger4",       "Pinky 1");
        public RigSlot LeftHandPinky2Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger41",      "Pinky 2");
        public RigSlot LeftHandPinky3Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_L_Finger42",      "Pinky 3");
        public RigSlot RightHandThumb1Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger0",       "Thumb 1");
        public RigSlot RightHandThumb2Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger01",      "Thumb 2");
        public RigSlot RightHandThumb3Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger02",      "Thumb 3");
        public RigSlot RightHandIndex1Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger1",       "Index 1");
        public RigSlot RightHandIndex2Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger11",      "Index 2");
        public RigSlot RightHandIndex3Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger12",      "Index 3");
        public RigSlot RightHandMiddle1Slot { get; set; } = new RigSlot(    "ValveBiped.Bip01_R_Finger2",       "Middle 1");
        public RigSlot RightHandMiddle2Slot { get; set; } = new RigSlot(    "ValveBiped.Bip01_R_Finger21",      "Middle 2");
        public RigSlot RightHandMiddle3Slot { get; set; } = new RigSlot(    "ValveBiped.Bip01_R_Finger22",      "Middle 3");
        public RigSlot RightHandRing1Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_R_Finger3",       "Ring 1");
        public RigSlot RightHandRing2Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_R_Finger31",      "Ring 2");
        public RigSlot RightHandRing3Slot { get; set; } = new RigSlot(      "ValveBiped.Bip01_R_Finger32",      "Ring 3");
        public RigSlot RightHandPinky1Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger4",       "Pinky 1");
        public RigSlot RightHandPinky2Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger41",      "Pinky 2");
        public RigSlot RightHandPinky3Slot { get; set; } = new RigSlot(     "ValveBiped.Bip01_R_Finger42",      "Pinky 3");
    }
}
