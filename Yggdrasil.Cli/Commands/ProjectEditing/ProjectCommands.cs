...
namespace Yggdrasil.Cli.Commands.ProjectEditing
{
    internal class ProjectCommands
    {
        ...
        public static void List(string[] args, Project project)
        {
            ...
            {
                void PrintBone(Yggdrasil.Domain.Scene.Bone bone, int indent = 0)
                {
                    if (bone != null)
                    {
                        ...
                        {
                            var childBone = child as Yggdrasil.Domain.Scene.Bone;
                            if (childBone != null)
